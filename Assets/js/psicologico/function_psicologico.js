...
function loadTable() {
  table = $("#tb").DataTable({
    ...
    ajax: {
      url: base_url + "psicologico/getPsicologico",
      dataSrc: "",
    },
    columns: [
      { data: "numero" },
      { data: "estadopsc_nombre" },
      { data: "estadopsc_descripcion" },
      { data: "estadopsc_peso" },
      { data: "estadopsc_estado" },
      { data: "acciones" },
    ],
    resonsieve: "true",
    bDestroy: true,
...
function save() {
  formS = $("#form_save").submit(function (e) {
    ...
    const request = axios.post(
      base_url + "Psicologico/savePsicologico",
      formData
    );
...
function eliminar() {
  $(document).on("click", ".__delete", function () {
    ...
    Swal.fire({
      title: "ELIMINAR ESTADO DE PSICOLOGICO",
      text: "¿Estas seguro de eliminar este estado de psicologico, no podrás revertir esto?",
      icon: "info",
      ...
      if (result.isConfirmed) {
        ...
        const request = axios.post(
          base_url + "Psicologico/delPsicologico",
          formData
        );
...
function update() {
  $("#form_update").submit(function (e) {
    ...
    const request = axios.post(
      base_url + "Psicologico/updPsicologico",
      formData
    );
