...
function save() {
  formS = $("#form_save").submit(function (e) {
    ...
    const request = axios.post(base_url + "Cargos/saveCargos", formData);
  ...
  $(document).on("click", ".__delete", function () {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const request = axios.post(base_url + "Cargos/delCargo", formData);
...
function update() {
  $("#form_update").submit(function (e) {
    ...
    const request = axios.post(base_url + "Cargos/updCargo", formData);
