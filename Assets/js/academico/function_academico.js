...
function loadTable() {
  table = $("#tb").DataTable({
    ...
    ajax: {
      url: base_url + "Academico/getAcademico",
      dataSrc: "",
    },
    columns: [
      { data: "numero" },
      { data: "nivel_nombre" },
      { data: "nivel_descripcion" },
      { data: "nivel_peso" },
      { data: "nivel_estado" },
      { data: "acciones" },
    ],
...
function save() {
  formS = $("#form_save").submit(function (e) {
    ...
    const request = axios.post(base_url + "Academico/saveAcademico", formData);
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        const request = axios.post(
          base_url + "Academico/delAcademico",
          formData
        );
