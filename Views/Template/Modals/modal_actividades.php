    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #00273C">
                <h1 class="modal-title title_mod fs-5" style="color: dodgerblue;" id="staticBackdropLabel">AGREGAR ACTIVIDAD</h1>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-10 mb-3">
                            <label class="small mb-0 fw-500">NOMBRE DE LA ACTIVIDAD:</label>
