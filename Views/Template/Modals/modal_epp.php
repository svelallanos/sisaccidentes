<!-- Modal -->
<div class="modal fade" id="modal_epp" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h1 class="modal-title title_mod fs-5 text-white" id="staticBackdropLabel">AGREGAR EPP</h1>
            ...
            <form id="form_epp">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="epp_id" id="epp_id">

                        <div class="col-md-12 mb-3">
                            <label class="small mb-0 fw-500">NOMBRE EPP:</label>
